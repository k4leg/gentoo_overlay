...
SRC_URI="
	https://github.com/emacs-tree-sitter/elisp-tree-sitter/archive/refs/tags/${PV}.tar.gz -> ${P}.tar.gz
	https://github.com/ubolonton/tree-sitter/archive/improve-text-provider.tar.gz
	$(cargo_crate_uris)
"
S="${WORKDIR}/elisp-tree-sitter-${PV}/core"
...
PATCHES=("${FILESDIR}/01-fix_cargo_toml.patch")
